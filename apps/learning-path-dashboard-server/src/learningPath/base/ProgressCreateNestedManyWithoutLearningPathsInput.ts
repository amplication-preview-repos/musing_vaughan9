...
@InputType()
class ProgressCreateNestedManyWithoutLearningPathsInput {
...
export { ProgressCreateNestedManyWithoutLearningPathsInput as ProgressCreateNestedManyWithoutLearningPathsInput };
