...
@InputType()
class LearningPathCreateNestedManyWithoutInstructorsInput {
...
export { LearningPathCreateNestedManyWithoutInstructorsInput as LearningPathCreateNestedManyWithoutInstructorsInput };
